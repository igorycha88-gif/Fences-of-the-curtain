...
| Изменение архитектуры проекта | Внедрение нового паттерна |
| Интеграция с внешним сервисом | Платёжный шлюз, CRM |
| Затрагивает >5 файлов | Глобальные изменения |
| Влияет на performance/scalability | Оптимизация запросов |
...
| Изменение бизнес-логики | → **Разработчик** | Расчёт калькулятора, валидация |
