...
async function main() {
  ...
  await prisma.review.createMany({
    data: [
      {
        name: 'Артём К.',
        text: 'Обратились с установкой навеса и забора, быстро приехали, провели все необходимые замеры, качественно провели все дальнейшие работы, а главное в короткий срок, плюсом дали гарантию на работу и материалы, нас все устроило во всех смыслах, рекомендую!',
        rating: 5,
        sortOrder: 1,
        active: true,
      },
    ...
    const picketData = [
      {
        ...
        length: 1500,
        color: 'RAL 8017',
        purchasePricePerUnit: 67.5,
        retailPricePerUnit: 97.5,
        active: true,
        priority: 0,
      ...
      },
      {
        ...
        length: 1500,
        color: 'RAL 8017',
        purchasePricePerUnit: 72,
        retailPricePerUnit: 102,
        active: true,
        priority: 0,
      ...
      },
      {
        ...
        length: 1800,
        color: 'RAL 8017',
        purchasePricePerUnit: 93.6,
        retailPricePerUnit: 135,
        active: true,
        priority: 0,
        profileTypeId: pProfileMap['М-образный'],
        coatingId: coatingMap['Глянцевый полиэстер'],
      },
      {
        ...
        length: 2000,
        color: 'RAL 8017',
        purchasePricePerUnit: 116,
        retailPricePerUnit: 164,
        active: true,
        priority: 0,
        profileTypeId: pProfileMap['М-образный'],
        coatingId: coatingMap['Глянцевый полиэстер'],
      },
      {
        ...
        length: 1500,
        color: 'RAL 8017',
        purchasePricePerUnit: 75,
        retailPricePerUnit: 108,
        active: true,
        priority: 0,
      ...
      },
      {
        ...
        length: 1800,
        color: 'RAL 8017',
        purchasePricePerUnit: 99,
        retailPricePerUnit: 140.4,
        active: true,
        priority: 0,
        profileTypeId: pProfileMap['Полукруглый (С-образный)'],
        coatingId: coatingMap['Глянцевый полиэстер'],
  ...
  console.log('[SEED] Seeding MeshType...');
  await prisma.meshType.createMany({
    data: [
      {
        name: 'Сетка-рабица 1.5м 50x1.8 оцинкованная',
        description: 'Сетка-рабица оцинкованная высотой 1.5м, ячейка 50мм, пруток 1.8мм',
        height: 1500,
        cellSize: 50,
        wireThickness: 1.8,
        coating: 'Оцинковка',
        purchasePricePerUnit: 280,
        retailPricePerUnit: 400,
        active: true,
        priority: 0,
      },
      {
        name: 'Сетка-рабица 2.0м 50x1.8 оцинкованная',
        description: 'Сетка-рабица оцинкованная высотой 2.0м, ячейка 50мм, пруток 1.8мм',
        height: 2000,
        cellSize: 50,
        wireThickness: 1.8,
        coating: 'Оцинковка',
      ...
      {
        name: 'Сетка-рабица 2.0м 50x2.0 оцинкованная',
        description: 'Сетка-рабица оцинкованная высотой 2.0м, ячейка 50мм, пруток 2.0мм',
        height: 2000,
        cellSize: 50,
        wireThickness: 2.0,
        coating: 'Оцинковка',
        purchasePricePerUnit: 420,
        retailPricePerUnit: 600,
        active: true,
        priority: 1,
      },
      {
        name: 'Сетка-рабица 2.0м 55x2.0 оцинкованная',
        description: 'Сетка-рабица оцинкованная высотой 2.0м, ячейка 55мм, пруток 2.0мм',
        height: 2000,
        cellSize: 55,
        wireThickness: 2.0,
        coating: 'Оцинковка',
        purchasePricePerUnit: 400,
        retailPricePerUnit: 570,
        active: true,
        priority: 2,
      },
      {
        name: 'Сетка-рабица 2.0м 50x1.8 полимерная',
        description: 'Сетка-рабица полимерная высотой 2.0м, ячейка 50мм, пруток 1.8мм',
        height: 2000,
        cellSize: 50,
        wireThickness: 1.8,
        coating: 'Полимерное',
      ...
      {
        name: 'Сетка-рабица 2.0м 50x2.0 полимерная',
        description: 'Сетка-рабица полимерная высотой 2.0м, ячейка 50мм, пруток 2.0мм',
        height: 2000,
        cellSize: 50,
        wireThickness: 2.0,
        coating: 'Полимерное',
        purchasePricePerUnit: 500,
        retailPricePerUnit: 720,
        active: true,
        priority: 1,
      },
      {
        name: 'Сетка-рабица 1.5м 50x2.0 оцинкованная',
        description: 'Сетка-рабица оцинкованная высотой 1.5м, ячейка 50мм, пруток 2.0мм',
        height: 1500,
        cellSize: 50,
        wireThickness: 2.0,
        coating: 'Оцинковка',
        purchasePricePerUnit: 320,
        retailPricePerUnit: 460,
        active: true,
        priority: 1,
      },
      {
        name: 'Сетка-рабица 1.5м 55x2.0 оцинкованная',
        description: 'Сетка-рабица оцинкованная высотой 1.5м, ячейка 55мм, пруток 2.0мм',
        height: 1500,
        cellSize: 55,
        wireThickness: 2.0,
        coating: 'Оцинковка',
        purchasePricePerUnit: 300,
        retailPricePerUnit: 430,
        active: true,
        priority: 2,
      },
      {
        name: 'Сетка-рабица 1.5м 50x1.8 полимерная',
        description: 'Сетка-рабица полимерная высотой 1.5м, ячейка 50мм, пруток 1.8мм',
        height: 1500,
        cellSize: 50,
        wireThickness: 1.8,
        coating: 'Полимерное',
        purchasePricePerUnit: 360,
        retailPricePerUnit: 520,
        active: true,
        priority: 0,
      },
      {
        name: 'Сетка-рабица 1.5м 50x2.0 полимерная',
        description: 'Сетка-рабица полимерная высотой 1.5м, ячейка 50мм, пруток 2.0мм',
        height: 1500,
        cellSize: 50,
        wireThickness: 2.0,
        coating: 'Полимерное',
        purchasePricePerUnit: 400,
        retailPricePerUnit: 580,
        active: true,
        priority: 1,
      },
    ],
