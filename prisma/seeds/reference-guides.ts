  ...
  const postTypes = await Promise.all([
    prisma.postType.upsert({
      ...
      create: {
        ...
        wallThickness: 2.0,
        pricePerMeter: 300,
        priceWithConcrete: 700,
        availableLengths: [
          { length: 2.5, pricePerMeter: 300, priceWithConcrete: 700 },
          { length: 3.0, pricePerMeter: 360, priceWithConcrete: 850 },
        ],
        active: true,
        sortOrder: 1,
      },
    ...
    prisma.postType.upsert({
      ...
      create: {
        ...
        wallThickness: 2.5,
        pricePerMeter: 450,
        priceWithConcrete: 1000,
        availableLengths: [
          { length: 2.5, pricePerMeter: 450, priceWithConcrete: 1000 },
          { length: 3.0, pricePerMeter: 540, priceWithConcrete: 1200 },
        ],
        active: true,
        sortOrder: 3,
      },
