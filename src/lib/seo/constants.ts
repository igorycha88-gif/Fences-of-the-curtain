export const SEO_CONFIG = {
  ...
  DEFAULT_DESCRIPTION: 'Заборы из профнастила от 1500 руб/м, евроштакетник от 1800 руб/м, навесы из поликарбоната от 2200 руб/м². Монтаж под ключ в Москве и МО. Онлайн-калькулятор. Гарантия. +7 (499) 390-15-95',
...
export const PAGE_METADATA = {
  home: {
    ...
    path: '/',
    description: 'Заборы из профнастила от 1500 руб/м, евроштакетник от 1800 руб/м. Навесы из поликарбоната под машину от 2200 руб/м². Монтаж под ключ в Москве и МО. Онлайн-калькулятор. +7 (499) 390-15-95',
