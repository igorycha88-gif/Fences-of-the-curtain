  ...
  return (
    <div ref={widgetRef} className="fixed bottom-6 right-6 z-40" data-testid="messenger-widget">
      {isOpen && (
        <div className="absolute bottom-full right-0 mb-3 w-64 rounded-2xl bg-popover border border-border shadow-2xl p-4 animate-fade-in-up">
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              <div className="w-10 h-10 rounded-full bg-[#26A5E4] flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
            ...
            <a
              ...
              className="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-secondary transition-colors group"
            >
              <div className="w-10 h-10 rounded-full bg-[#007AFF] flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
      ...
      <button
        ...
        className="flex items-center gap-2 px-5 py-3 bg-primary hover:bg-primary/90 text-primary-foreground rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
      ...
      >
        ...
        <span className="font-medium text-sm">Напиши нам</span>
      </button>
    </div>
  );
}
