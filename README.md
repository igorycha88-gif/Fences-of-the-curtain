...
- **Расчет работ по монтажу** с привязкой к типам забора:
  - Поддержка единицы измерения "метр погонный" (м.п.)
  - Автоматический расчет стоимости работ при выборе типа забора
  - Расчет: длина забора × цена за метр погонный
  - Поддержка разных единиц: метр погонный, фиксированная цена, штуки
