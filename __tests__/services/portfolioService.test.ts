...
describe('PortfolioService', () => {
  ...
  describe('getAll', () => {
    it('should return paginated list', async () => {
      ...
      (prisma.portfolioItem.findMany as jest.Mock).mockResolvedValue(mockItems);
      (prisma.portfolioItem.count as jest.Mock).mockResolvedValue(2);
    ...
    it('should filter by category', async () => {
      ...
      (prisma.portfolioItem.count as jest.Mock).mockResolvedValue(0);
  ...
  describe('getById', () => {
    it('should return item by id', async () => {
      ...
      (prisma.portfolioItem.findUnique as jest.Mock).mockResolvedValue(mockItem);
  ...
  describe('create', () => {
    it('should create item with auto sortOrder', async () => {
      ...
      (prisma.portfolioItem.aggregate as jest.Mock).mockResolvedValue({
        _max: { sortOrder: 5 },
      });
      (prisma.portfolioItem.create as jest.Mock).mockResolvedValue(mockItem);
  ...
  describe('toggleActive', () => {
    it('should toggle active status', async () => {
      ...
      (prisma.portfolioItem.findUnique as jest.Mock).mockResolvedValue(oldItem);
      (prisma.portfolioItem.update as jest.Mock).mockResolvedValue(newItem);
      (prisma.auditLog.create as jest.Mock).mockResolvedValue({});
