...
describe('JSON-LD Generators', () => {
  describe('generateOrganizationJsonLd', () => {
    it('should generate valid Organization schema', () => {
      ...
      expect(result.url).toBe(SEO_CONFIG.BASE_URL);
    });
    ...
    it('should have @id field', () => {
      ...
      expect(result['@id']).toBe(`${SEO_CONFIG.BASE_URL}/#organization`);
    });
  ...
  describe('generateWebSiteJsonLd', () => {
    ...
    it('should have search action', () => {
      ...
      expect(result.potentialAction?.target).toBe(`${SEO_CONFIG.BASE_URL}/search?q={search_term_string}`);
  ...
  describe('generateServiceJsonLd', () => {
    ...
    it('should have provider reference', () => {
      ...
      expect(result.provider?.['@id']).toBe(`${SEO_CONFIG.BASE_URL}/#organization`);
    });
    ...
    it('should include price range', () => {
      ...
      expect(result.offers?.priceRange).toBe('from 1500 руб/м');
    });
  ...
  describe('generateWebApplicationJsonLd', () => {
    ...
    it('should generate full URL', () => {
      ...
      expect(result.url).toBe(`${SEO_CONFIG.BASE_URL}/calculator/fence`);
    });
  ...
  describe('generateBreadcrumbJsonLd', () => {
    ...
    it('should generate full URLs', () => {
      ...
      expect(result.itemListElement[0].item).toBe(`${SEO_CONFIG.BASE_URL}/`);
    });
  ...
  describe('generateContactPageJsonLd', () => {
    it('should generate valid ContactPage schema', () => {
      ...
      expect(result.url).toBe(`${SEO_CONFIG.BASE_URL}/contacts`);
    });
    ...
    it('should have mainEntity reference', () => {
      ...
      expect(result.mainEntity?.['@id']).toBe(`${SEO_CONFIG.BASE_URL}/#organization`);
    });
